...
${emojis.premium.flower} <b>Нейролюб Клуб</b> – закрытый клуб с <b>авторскими промптами, материалыми и советами по созданию промптов</b>, а еще с поддержкой и общением с единомышленниками.
